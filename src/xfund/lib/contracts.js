...
import XTokenAbi from './abi/XToken.json'
import XFundAbi from './abi/XFund.json'
import {
  contractAddresses,
  SUBTRACT_GAS_LIMIT,
  supportedPools,
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    this.cpm = new this.web3.eth.Contract(NFTAbi)
    this.xToken = new this.web3.eth.Contract(XTokenAbi)
    this.xFund = new this.web3.eth.Contract(XFundAbi)
  ...
  setProvider(provider, networkId) {
    ...
    setProvider(this.cpm, contractAddresses.cpm[networkId])
    setProvider(this.xToken, contractAddresses.xToken[networkId])
    setProvider(this.xFund, contractAddresses.xFund[networkId])
  ...
  setDefaultAccount(account) {
    this.xFund.options.from = account
