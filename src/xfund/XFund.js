...
export class XFund {
  constructor(provider, networkId, testing, options) {
    ...
    this.cpmAddress = contractAddresses.cpm[networkId]
    this.xTokenAddress = contractAddresses.xToken[networkId]
    this.xFundAddress = contractAddresses.xFund[networkId]
  }
